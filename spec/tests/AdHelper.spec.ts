  ...
  describe('formatAdErrorEvent', () => {
    it('should format error message', () => {
      expect(
        ...
        'Ad error: Test error; Message: Unknown message; Error code: 1400; Troubleshoot link: https://test.com',
      );
    });
    ...
    it('should format full error message', () => {
      expect(
        ...
        'Ad error: Test error; Ad error code: 123; Message: Test message; Error code: 1400; Troubleshoot link: https://test.com',
      );
    });
  });
